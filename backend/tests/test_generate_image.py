...
class TestImageGeneratorUnit:
    ...
    def test_generate_image_api_failure(self, mocker, image_generator):
        ...
        mocker.patch.object(
            image_generator.client.images, "generate", side_effect=Exception("API request failed")
        )
    ...
    def test_generate_image_invalid_prompt(self, mocker, image_generator):
        ...
        mocker.patch.object(
            image_generator.client.images, "generate", side_effect=Exception("Invalid prompt")
        )
    ...
    def test_logging_when_api_fails(self, mocker, image_generator):
        ...
        mocker.patch.object(
            image_generator.client.images, "generate", side_effect=Exception("API failure")
        )
